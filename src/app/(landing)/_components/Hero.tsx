  ...
  return (
    ...
    <>
      ...
      <section className='z-10 flex flex-col justify-end relative md:grid md:grid-cols-[minmax(0,_100px)_500px_minmax(0,_1fr)] md:grid-rows-[200px_1fr_200px] h-[60vh] md:h-[80vh] md:place-items-center '>
        <div className='absolute bottom-0 h-56 xs:h-40 w-full md:inset-0 md:h-auto bg-orange-700/30 md:rounded-xl col-start-2 col-span-1 row-start-2 row-span-1 z-30 backdrop-blur-lg' />
        <article className='px-6 pb-4 rounded-xl col-start-2 row-start-2 row-span-1 z-40 md:px-10 md:py-8'>
          <h1 className='text-3xl md:text-4xl text-white font-extrabold leading-relaxed'>
          ...
          <h2 className='text-md text-landing font-semibold md:text-lg mt-4 max-w-[40ch]'>
